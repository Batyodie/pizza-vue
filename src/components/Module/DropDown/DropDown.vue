<template>
  <div ref="DropDownBlock" :class="DropDownStyle.DropDown">
    <div style="display: flex; align-items: center;">
      ...
      <button @click="DropDownOpened" :class="DropDownStyle.DropDownBtn">
        <slot name="DropdownBtnText">
          {{ getState.DropDownItemIsActive.text }}
        </slot>
      </button>
    </div>
    <div v-show="getState.DropDownIsOpen" :class="DropDownStyle.DropDownPopUp">
      <ul :class="DropDownStyle.DropDownList">
        <li
          :class="[
            getState.DropDownItemIsActive.type === DropDownItem.type
              ? [DropDownStyle.DropDownItemActive]
              : '',
