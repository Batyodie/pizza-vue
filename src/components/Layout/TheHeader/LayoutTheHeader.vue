  ...
  <header :class="LayoutTheHeader.Wrapper">
    ...
    <template v-if="IsActiveButton">
      <router-link to="/basket" style="text-decoration: none">
        <Button :class="[BtnStyle.BtnBasket, LayoutTheHeader.ButtonMargin]">
          <template slot="Icon">
            <img
              ...
              alt="icon basket"
            />
            <span :class="BtnStyle.BtnBody">{{ itemsCount }}</span>
          </template>
          <template slot="IconBorder">
            <span :class="BtnStyle.BtnIconBorder"></span>
          </template>
...
// button
import Button from "@/components/Module/Button/Button.vue";
import BtnStyle from "@/components/Module/Button/Button.css";

import Logo from "@/components/Module/Logo/Logo.vue";
